...
let url = 'http://localhost:5000/get_interview_detail/'+id;
...
fetch(url)
    ...
    .then(data => {
        ...
        let end_time = moment(data.data[0].end_begin).format("MMMM Do YYYY, h:mm:ss a");
        ...
        document.getElementById("prev_end_time").innerHTML = "Previous beginning time was : " + end_time;
